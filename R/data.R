...
#' cities spanning from 1348 to 1835, compiled by Dean et al.
#'
#' @format A tibble with 1,845 rows and 6 variables:
#' \describe{
...
#'   \item{day}{Time period (day for most datasets, week for London 1563)}
#'   \item{deaths}{Number of deaths from plague}
#' }
#'
#' @details
...
#'   \item London 1563 (weekly data, 225 weeks)
...
#' incomplete. The London 1563 dataset contains weekly rather than daily
#' mortality counts (but uses the same 'day' column for consistency).
#'

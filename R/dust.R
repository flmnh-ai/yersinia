...
plague_stochastic_humans <- structure(
  ...
  parameters = data.frame(
    name = c("tau", "I_ini", "R_ini", "K_r", "K_h", "r_r", "r_h", "p", "d_r", "d_h", "beta_r", "beta_h", "beta_I", "rho", "m_r", "m_h", "g_r", "g_h", "delta_R", "kappa", "p_obs", "iota", "I_h_ini", "R_h_ini", "lambda_baseline", "obs_period", "seasonal_beta"),
...
plague_stochastic_metapop <- structure(
  ...
  path = NULL,
  parameters = data.frame(
    name = c("npop", "tau", "mu_r", "contact_r", "mu_h", "contact_h", "K_r", "K_h", "I_ini", "R_ini", "I_h_ini", "R_h_ini", "r_r", "r_h", "p", "d_r", "d_h", "beta_r", "beta_h", "beta_I", "rho", "m_r", "m_h", "g_r", "g_h", "delta_R", "iota", "obs_period", "seasonal_beta"),
    ...
    rank = c(0L, 0L, 0L, 2L, 0L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 0L, 2L)),
  properties = list(
    time_type = "discrete",
    has_compare = FALSE,
    has_adjoint = FALSE),

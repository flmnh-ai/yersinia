...
The `plagueR` package provides a comprehensive toolkit for plague transmission modeling that includes:
...
- **Package documentation**: Use `help(package = "plagueR")` for function references

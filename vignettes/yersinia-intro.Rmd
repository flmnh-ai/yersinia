...
```{r basic-model}
# Run a basic stochastic model
results <- run_plague_model(
  params = "defaults",
  npop = 1,                    # Single population
...
Environmental seasonality affects flea dynamics:
...
for (intervention in interventions) {
  ...
  result <- do.call(run_plague_model, c(
    params_list,
    list(npop = 1, n_particles = 20, times = seq(0, 5, by = 0.1))
  ))
